...
import MICRO_SERVICE from '../../assets/images/micro-service.png';
    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="container flex flex-col items-center px-4 pt-20 pb-12 mx-auto">
        ...
        <p className="block max-w-2xl mt-4 text-base text-gray-500 dark:text-gray-300">
          Microfrontend or Module Federation is a front-end web development
          pattern in which a single application may be built from disparate
          builds.
        </p>
        <p className="block max-w-2xl mt-3 text-base text-gray-500 dark:text-gray-300">
          It is analogous to a microservices approach but for client-side
          single-page applications written in JavaScript
        </p>

        <div className="mt-6">
          <div className="inline-flex w-full overflow-hidden rounded-lg shadow sm:w-auto sm:mx-3">
            <a
              href={`http://${process.env.MFES_GOBIKE}`}
          ...
          <div className="inline-flex w-full mt-4 overflow-hidden rounded-lg shadow sm:w-auto sm:mx-3 sm:mt-0">
            ...
            >
              ...
              <span className="mx-2">Launch GoHike App!</span>
            </a>
          </div>
        </div>
      </div>
